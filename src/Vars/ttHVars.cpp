...
ttHVars::ttHVars(bool makeHistos, bool useTTHLoose){
  ...
  */
  ...
  _floatVars["mu1_jetDeepCSV"] = 999.;
  _floatVars["mu1_jetDeepJet"] = 999.;
  _floatVars["mu1_dxy"] = 999.;
  _floatVars["mu1_isGenMatched"] = 999.;
  ...
  _floatVars["mu2_jetDeepCSV"] = 999.;
  _floatVars["mu2_jetDeepJet"] = 999.;
  _floatVars["mu2_dxy"] = 999.;
  _floatVars["mu2_isGenMatched"] = 999.;
  ...
  _floatVars["ele1_jetDeepCSV"] = 999.;
  _floatVars["ele1_jetDeepJet"] = 999.;
  _floatVars["ele1_dxy"] = 999.;
  _floatVars["ele1_isGenMatched"] = 999.;
  ...
  _floatVars["ele2_jetDeepCSV"] = 999.;
  _floatVars["ele2_jetDeepJet"] = 999.;
  _floatVars["ele2_dxy"] = 999.;
  _floatVars["ele2_isGenMatched"] = 999.;
  ...
  _floatVars["min_Deta_leadfwdJet_jet"] = 999.;
  _floatVars["min_Deta_mostfwdJet_jet"] = 999.;
  ...
  _floatVars["cosa_highest2b"] = 999.;
  _floatVars["acuteangle_bbpp_highest2b"] = 999.;
  _floatVars["deta_highest2b"] = 999.;
  ...
  _floatVars["Bin4Lctrl"] = 999;
  _floatVars["nZPair"] = 999;
  ...
  _floatVars["is3lctrlSR"] = 999;
  _floatVars["is3lctrlFake"] = 999;
  _floatVars["is4lctrlSR"] = 999;
  _floatVars["is4lctrlFake"] = 999;
...
void ttHVars::Clear(){
    ...
    ele2_deltaPhi = -9;
    ele2_OoEminusOoP = -9;
    ele1_isChargeConsistent = -9;
    ele1_passesConversionVeto = -9;
    ele2_isfakeablesel = -9;
    ele2_ismvasel = -9;
    ele2_isChargeConsistent = -9;
    ele2_passesConversionVeto = -9;
    ls = -9;
    run = -9;
    n_presel_mu = -9;
    n_fakeablesel_mu = -9;
    ...
    nLightJet = -9;
    mu1_charge = -9;
    mu1_jetNDauChargedMVASel = -9;
    mu2_charge = -9;
    mu2_jetNDauChargedMVASel = -9;
    ele1_charge = -9;
    ele1_jetNDauChargedMVASel = -9;
    ele1_nMissingHits = -9;
    ele2_charge = -9;
    ele2_jetNDauChargedMVASel = -9;
    ele2_nMissingHits = -9;
    tau1_charge = -9;
    tau1_decayModeFindingOldDMs = -9;
    tau1_decayModeFindingNewDMs = -9;
    tau1_byLooseCombinedIsolationDeltaBetaCorr3Hits = -9;
    tau1_byMediumCombinedIsolationDeltaBetaCorr3Hits = -9;
    tau1_byTightCombinedIsolationDeltaBetaCorr3Hits = -9;
    tau1_byLooseCombinedIsolationDeltaBetaCorr3HitsdR03 = -9;
    tau1_byMediumCombinedIsolationDeltaBetaCorr3HitsdR03 = -9;
    tau1_byTightCombinedIsolationDeltaBetaCorr3HitsdR03 = -9;
    tau1_byLooseIsolationMVArun2v1DBdR03oldDMwLT = -9;
    tau1_rawMVArun2v1DBdR03oldDMwLT = -9;
    tau1_byVLooseIsolationMVArun2v1DBdR03oldDMwLT = -9;
    tau1_byMediumIsolationMVArun2v1DBdR03oldDMwLT = -9;
    tau1_byTightIsolationMVArun2v1DBdR03oldDMwLT = -9;
    tau1_byVTightIsolationMVArun2v1DBdR03oldDMwLT = -9;
    tau2_charge = -9;
    tau2_decayModeFindingOldDMs = -9;
    tau2_decayModeFindingNewDMs = -9;
    tau2_byLooseCombinedIsolationDeltaBetaCorr3Hits = -9;
    tau2_byMediumCombinedIsolationDeltaBetaCorr3Hits = -9;
    tau2_byTightCombinedIsolationDeltaBetaCorr3Hits = -9;
    tau2_byLooseCombinedIsolationDeltaBetaCorr3HitsdR03 = -9;
    tau2_byMediumCombinedIsolationDeltaBetaCorr3HitsdR03 = -9;
    tau2_byTightCombinedIsolationDeltaBetaCorr3HitsdR03 = -9;
    tau2_byLooseIsolationMVArun2v1DBdR03oldDMwLT = -9;
    tau2_rawMVArun2v1DBdR03oldDMwLT = -9;
    tau2_byVLooseIsolationMVArun2v1DBdR03oldDMwLT = -9;
    tau2_byMediumIsolationMVArun2v1DBdR03oldDMwLT = -9;
    tau2_byTightIsolationMVArun2v1DBdR03oldDMwLT = -9;
    tau2_byVTightIsolationMVArun2v1DBdR03oldDMwLT = -9;
    mu1_pt = -9;
    mu1_conept = -9;
    mu1_eta = -9;
    mu1_phi = -9;
    mu1_E = -9;
    mu1_miniRelIso = -9;
    mu1_miniIsoCharged = -9;
    mu1_miniIsoNeutral = -9;
    mu1_jetPtRel = -9;
    mu1_jetPtRatio = -9;
    mu1_jetCSV = -9;
    mu1_jetDeepCSV = -9;
    ...
    mu2_E = -9;
    mu2_miniRelIso = -9;
    mu2_miniIsoCharged = -9;
    mu2_miniIsoNeutral = -9;
    mu2_jetPtRel = -9;
    mu2_jetPtRatio = -9;
    mu2_jetCSV = -9;
    mu2_jetDeepCSV = -9;
    ...
    ele1_E = -9;
    ele1_miniRelIso = -9;
    ele1_miniIsoCharged = -9;
    ele1_miniIsoNeutral = -9;
    ele1_jetPtRel = -9;
    ele1_jetPtRatio = -9;
    ele1_jetCSV = -9;
    ele1_jetDeepCSV = -9;
    ...
    ele2_E = -9;
    ele2_miniRelIso = -9;
    ele2_miniIsoCharged = -9;
    ele2_miniIsoNeutral = -9;
    ele2_jetPtRel = -9;
    ele2_jetPtRatio = -9;
    ele2_jetCSV = -9;
    ele2_jetDeepCSV = -9;
    ...
    tau1_dxy = -9;
    tau1_dz = -9;
    tau1_byCombinedIsolationDeltaBetaCorr3Hits = -9;
    tau2_pt = -9;
    tau2_eta = -9;
    tau2_phi = -9;
    tau2_E = -9;
    tau2_dxy = -9;
    tau2_dz = -9;
    tau2_byCombinedIsolationDeltaBetaCorr3Hits = -9;
    jet1_pt = -9;
    jet1_eta = -9;
    jet1_phi = -9;
    jet1_E = -9;
    ...
    mT_lep1 = -9;
    avg_dr_jet = -9;
    mvaOutput_2lss_ttV = -9;
    mvaOutput_2lss_ttbar = -9;
    lep3_conePt = -9;
    mindr_lep3_jet = -9;
    min_dr_lep_jet = -9;
    dr_leps = -9;
    ...
    lep3_passConv = -9;
    lep1_E = -9;
    lep1_isfakeablesel = -9;
    lep1_ismvasel = -9;
    lep2_E = -9;
    lep2_isfakeablesel = -9;
    lep2_ismvasel = -9;
    lep3_E = -9;
    lep3_isfakeablesel = -9;
    lep3_ismvasel = -9;
    genWeight_muF2 = -9;
    genWeight_muF0p5 = -9;
    genWeight_muR2 = -9;
...
void ttHVars::FillBranches(EventContainer * evtObj){
    ...
    */
    ...
    _floatVars["nElectron"] = nElectron;
    ...
    if(Jets.size()>=1){
        ...
        jet1_E = FirstJet.E();
        jet1_CSV = FirstJet.pfCombinedInclusiveSecondaryVertexV2BJetTags();
        jet1_DeepCSV = FirstJet.pfDeepCSVBJetTags();
        jet1_DeepJet = FirstJet.pfDeepFlavourBJetTags();
        jet1_QGdiscr = FirstJet.qg();
    }
    if(Jets.size()>=2){
        ...
        jet2_E = SecondJet.E();
        jet2_CSV = SecondJet.pfCombinedInclusiveSecondaryVertexV2BJetTags();
        jet2_DeepCSV = SecondJet.pfDeepCSVBJetTags();
        jet2_DeepJet = SecondJet.pfDeepFlavourBJetTags();
        jet2_QGdiscr = SecondJet.qg();
    }
    if(Jets.size()>=3){
        jet3_pt = ThirdJet.Pt();
        ...
        jet3_E = ThirdJet.E();
        jet3_CSV = ThirdJet.pfCombinedInclusiveSecondaryVertexV2BJetTags();
        jet3_DeepCSV = ThirdJet.pfDeepCSVBJetTags();
        jet3_DeepJet = ThirdJet.pfDeepFlavourBJetTags();
        jet3_QGdiscr = ThirdJet.qg();
    }
    if(Jets.size()>=4){
        ...
        jet4_E = FourthJet.E();
        jet4_CSV = FourthJet.pfCombinedInclusiveSecondaryVertexV2BJetTags();
        jet4_DeepCSV = FourthJet.pfDeepCSVBJetTags();
        jet4_DeepJet = FourthJet.pfDeepFlavourBJetTags();
        jet4_QGdiscr = FourthJet.qg();
    }
    if(Jets.size()>=5){
        jet5_pt = FifthJet.Pt();
        ...
        jet5_E = FifthJet.E();
        jet5_CSV = FifthJet.pfCombinedInclusiveSecondaryVertexV2BJetTags();
        jet5_DeepCSV = FifthJet.pfDeepCSVBJetTags();
        jet5_DeepJet = FifthJet.pfDeepFlavourBJetTags();
        jet5_QGdiscr = FifthJet.qg();
    }
    if(Jets.size()>=6){
        jet6_pt = SixthJet.Pt();
        ...
        jet6_E = SixthJet.E();
        jet6_CSV = SixthJet.pfCombinedInclusiveSecondaryVertexV2BJetTags();
        jet6_DeepCSV = SixthJet.pfDeepCSVBJetTags();
        jet6_DeepJet = SixthJet.pfDeepFlavourBJetTags();
        jet6_QGdiscr = SixthJet.qg();
    }
    if(Jets.size()>=7){
        ...
        jet7_E = SeventhJet.E();
        jet7_CSV = SeventhJet.pfCombinedInclusiveSecondaryVertexV2BJetTags();
        jet7_DeepCSV = SeventhJet.pfDeepCSVBJetTags();
        jet7_DeepJet = SeventhJet.pfDeepFlavourBJetTags();
        jet7_QGdiscr = SeventhJet.qg();
    }
    if(Jets.size()>=8){
        ...
        jet8_E = EighthJet.E();
        jet8_CSV = EighthJet.pfCombinedInclusiveSecondaryVertexV2BJetTags();
        jet8_DeepCSV = EighthJet.pfDeepCSVBJetTags();
        jet8_DeepJet = EighthJet.pfDeepFlavourBJetTags();
        jet8_QGdiscr = EighthJet.qg();
    }
    if(fwdJets.size()>=1){
        min_Deta_leadfwdJet_jet = min_Deta(FirstFwdJet, Jets);
        std::sort(fwdJets.begin(),fwdJets.end(),[](const Jet &a, const Jet &b){return fabs(a.Eta()) > fabs(b.Eta());});
        min_Deta_mostfwdJet_jet = min_Deta(fwdJets.at(0), Jets);
  ...
  _floatVars["mu1_jetDeepCSV"] = mu1_jetDeepCSV;
  _floatVars["mu1_jetDeepJet"] = mu1_jetDeepJet;
  _floatVars["mu1_dxy"] = mu1_dxy;
  _floatVars["mu1_isGenMatched"] = mu1_isGenMatched;
  ...
  _floatVars["mu2_jetDeepCSV"] = mu2_jetDeepCSV;
  _floatVars["mu2_jetDeepJet"] = mu2_jetDeepJet;
  _floatVars["mu2_dxy"] = mu2_dxy;
  _floatVars["mu2_isGenMatched"] = mu2_isGenMatched;
  ...
  _floatVars["ele1_jetDeepCSV"] = ele1_jetDeepCSV;
  _floatVars["ele1_jetDeepJet"] = ele1_jetDeepJet;
  _floatVars["ele1_dxy"] = ele1_dxy;
  _floatVars["ele1_isGenMatched"] = ele1_isGenMatched;
  ...
  _floatVars["ele2_jetDeepCSV"] = ele2_jetDeepCSV;
  _floatVars["ele2_jetDeepJet"] = ele2_jetDeepJet;
  _floatVars["ele2_dxy"] = ele2_dxy;
  _floatVars["ele2_isGenMatched"] = ele2_isGenMatched;
  ...
  _floatVars["jet1_DeepCSV"] = jet1_DeepCSV;
  _floatVars["jet1_DeepJet"] = jet1_DeepJet;
  _floatVars["jet1_QGdiscr"] = jet1_QGdiscr;
  ...
  _floatVars["jet2_DeepCSV"] = jet2_DeepCSV;
  _floatVars["jet2_DeepJet"] = jet2_DeepJet;
  _floatVars["jet2_QGdiscr"] = jet2_QGdiscr;
  ...
  _floatVars["jet3_DeepCSV"] = jet3_DeepCSV;
  _floatVars["jet3_DeepJet"] = jet3_DeepJet;
  _floatVars["jet3_QGdiscr"] = jet3_QGdiscr;
  ...
  _floatVars["jet4_DeepCSV"] = jet4_DeepCSV;
  _floatVars["jet4_DeepJet"] = jet4_DeepJet;
  _floatVars["jet4_QGdiscr"] = jet4_QGdiscr;
  ...
  _floatVars["jet5_DeepCSV"] = jet5_DeepCSV;
  _floatVars["jet5_DeepJet"] = jet5_DeepJet;
  _floatVars["jet5_QGdiscr"] = jet5_QGdiscr;
  ...
  _floatVars["jet6_DeepCSV"] = jet6_DeepCSV;
  _floatVars["jet6_DeepJet"] = jet6_DeepJet;
  _floatVars["jet6_QGdiscr"] = jet6_QGdiscr;
  ...
  _floatVars["jet7_DeepCSV"] = jet7_DeepCSV;
  _floatVars["jet7_DeepJet"] = jet7_DeepJet;
  _floatVars["jet7_QGdiscr"] = jet7_QGdiscr;
  ...
  _floatVars["min_Deta_leadfwdJet_jet"] = min_Deta_leadfwdJet_jet;
  _floatVars["min_Deta_mostfwdJet_jet"] = min_Deta_mostfwdJet_jet;
  ...
  _floatVars["deta_highest2b"] = deta_highest2b;
  _floatVars["acuteangle_bbpp_highest2b"] = acuteangle_bbpp_highest2b;
  _floatVars["cosa_highest2b"] = cosa_highest2b;
  ...
  _floatVars["Bin4Lctrl"] = Bin4Lctrl;
  _floatVars["nZPair"] = nZPair;
  ...
  _floatVars["genWeight_muR0p5"] = genWeight_muR0p5;
    ...
    // now add some flags
    // FIXME
    // when useTTHLoose = true, only isDiLepSR, isttWctrlSR, istHlikeDiLepSR returns expected value
    // I assume you want to use TTHLoose only for MVA analysis and we care only dilep categories
    // and yes, I'm too lazy to change 3 lepton and 4 lepton flags.
   ...
   is3lctrlSR = Is3lctrlSR(evtObj)? 1:0;
   is3lctrlFake = Is3lctrlFake(evtObj)? 1:0;
   is4lctrlSR = Is4lctrlSR(evtObj)? 1:0;
   is4lctrlFake = Is4lctrlFake(evtObj)? 1:0;
   ...
   _floatVars["is3lctrlSR"] = is3lctrlSR;
   _floatVars["is3lctrlFake"] = is3lctrlFake;
   _floatVars["is4lctrlSR"] = is4lctrlSR;
   _floatVars["is4lctrlFake"] = is4lctrlFake;
...
void ttHVars::Cal_event_variables(EventContainer* EvtObj){
    ...
    int nZpair = 0;
    for(uint lep1_en=0; lep1_en<min(4,int(fakeLeptons.size()));lep1_en++){
        for(uint lep2_en=lep1_en+1; lep2_en<min(4,int(fakeLeptons.size()));lep2_en++){
            Lepton firstLepton = fakeLeptons.at(lep1_en);
            Lepton secondLepton = fakeLeptons.at(lep2_en);
            if((firstLepton.pdgId() + secondLepton.pdgId())==0){
                isSFOS_metLD = 1;
                //break;
            }
            Lep1.SetPtEtaPhiE(firstLepton.Pt(),firstLepton.Eta(),firstLepton.Phi(),firstLepton.E());
            Lep2.SetPtEtaPhiE(secondLepton.Pt(),secondLepton.Eta(),secondLepton.Phi(),secondLepton.E());
            double curr_mass = (Lep1+Lep2).M();
            if(fabs(curr_mass-91.2) < 10 && (firstLepton.pdgId() + secondLepton.pdgId())==0 )nZpair +=1; 
    ...
    HtJet = SumPt;
    int Bin4lctrl =0;
    if(nZpair==2)Bin4lctrl=1;
    else if (nZpair ==1 && Jet_numLoose==0)Bin4lctrl=2;
    else if (nZpair ==1 && Jet_numbMedium==1)Bin4lctrl=3;
    else if (nZpair ==1 && Jet_numbMedium>1)Bin4lctrl=4;
    Bin4Lctrl = Bin4lctrl;
    int lepton_num =0;
    ...
    if(lepton_num>=2){
        ...
        massLT = getMTlepmet((FakeLep1+FakeLep2).Phi(), EvtObj->missingPhi, (FakeLep1+FakeLep2).Pt(), EvtObj->missingEt);
        ...
        double b2_CSV= -999;
        for(uint jet_en=0; jet_en < Jets.size(); jet_en++){
           Jet current_jet = Jets.at(jet_en);
           // deep CSV loose b
           if(current_jet.isLooseBdisc()){
                if(fabs(loosebJet1.Pt())<0.0001) loosebJet1.SetPtEtaPhiE(current_jet.Pt(),current_jet.Eta(),current_jet.Phi(),current_jet.E());
                else if(fabs(loosebJet2.Pt())<0.0001) loosebJet2.SetPtEtaPhiE(current_jet.Pt(),current_jet.Eta(),current_jet.Phi(),current_jet.E());
           }
           // deep CSV value ordered
           if(current_jet.bDiscriminator()>b1_CSV){
               // set b2 to old b1
               b2_CSV = b1_CSV;
               bJet2 = bJet1;
               // set b1 to current jet
               b1_CSV = current_jet.bDiscriminator();
               bJet1.SetPtEtaPhiE(current_jet.Pt(),current_jet.Eta(),current_jet.Phi(),current_jet.E());
           } else if(current_jet.bDiscriminator()>b2_CSV){
               // set b2 to current jet
               b2_CSV = current_jet.bDiscriminator();
               bJet2.SetPtEtaPhiE(current_jet.Pt(),current_jet.Eta(),current_jet.Phi(),current_jet.E());
           }
        }
        ...
        if(bJet1.Vect().Mag()!=0 && bJet2.Vect().Mag()!=0){
            TVector3 v3A = bJet1.Vect();
            TVector3 v3B = bJet2.Vect();
            cosa_highest2b = v3A.Dot(v3B)/(v3A.Mag()*v3B.Mag());
        };
        // calculate mT2 vars
...
double ttHVars::min_Deta(Jet fwdJet, std::vector<Jet> selJets){
    double min_Deta = 99;
    for(auto jet: selJets){
        if (fabs(jet.Eta() - fwdJet.Eta())< min_Deta) min_Deta = fabs(jet.Eta() - fwdJet.Eta());
    }
    return min_Deta;
}

// angles
double ttHVars::getAngleOfPlanes(TVector3 plane1_vectA, TVector3 plane1_vectB, TVector3 plane2_vectA, TVector3 plane2_vectB){
    double angle = -999;
...
// Lorentz Boost
double ttHVars::get_boostedAngle(TLorentzVector Particle1_CMS, TLorentzVector Particle2_CMS, TLorentzVector plane1_vectA, TLorentzVector plane1_vectB, TLorentzVector plane2_vectA, TLorentzVector plane2_vectB){
...
bool ttHVars::IsDiLepSR(EventContainer* EvtObj){
    ...
    if(!_useTTHLoose){
        ...
        if(nLep_Cat !=2 || (n_presel_ele + n_presel_mu) <2) return false;
        if(!( looseLeptons.at(0).charge() * looseLeptons.at(1).charge() >0))return false; // same sign leptons
        if(!(EvtObj->mass_dillep > 101.2 || EvtObj->mass_dillep < 81.2)) return false; // cut Z veto
        if(EvtObj->metLD <= 30 && fabs(looseLeptons.at(0).pdgId())==11 && fabs(looseLeptons.at(1).pdgId())==11 ) return false; // metLD if isEE, then metLD > 30GeV
        return true;
    }
};
...
bool ttHVars::IsTriLepSR(EventContainer* EvtObj){
    ...
    if(!(EvtObj->massL_SFOS > 101.2 || EvtObj->massL_SFOS < 81.2)) return false; // cut Z veto
    //if(!(EvtObj->metLD > (isSFOS_metLD ==1 ? 45 : 30) || n_presel_jet>=4)) return false; // nJet >=4 or (metLD > 30GeV, if SFOS, metLD > 45)
...
bool ttHVars::Is3lctrlSR(EventContainer* EvtObj){
    if(nLep_Cat !=3 || nLepFO <3) return false;
    if(!( fakeLeptons.at(0).isMVASel() ==1 && fakeLeptons.at(1).isMVASel() ==1 && fakeLeptons.at(2).isMVASel() ==1))return false; // selected leptons are tights
    if(EvtObj->massL_SFOS > 101.2 || EvtObj->massL_SFOS < 81.2) return false; // inversed cut Z veto
    //if(!(EvtObj->metLD > (isSFOS_metLD ==1 ? 45 : 30) || n_presel_jet>=4)) return false; // nJet >=4 or (metLD > 30GeV, if SFOS, metLD > 45)
    if(!n_presel_jet>=1) return false;
    return true;
};
bool ttHVars::Is3lctrlFake(EventContainer* EvtObj){
    if(nLep_Cat !=3 || nLepFO <3) return false;
    if(fakeLeptons.at(0).isMVASel() ==1 && fakeLeptons.at(1).isMVASel() ==1 && fakeLeptons.at(2).isMVASel() ==1)return false; // selected leptons are not all tights
    if(EvtObj->massL_SFOS > 101.2 || EvtObj->massL_SFOS < 81.2) return false; // inversed cut Z veto
    //if(!(EvtObj->metLD > (isSFOS_metLD ==1 ? 45 : 30) || n_presel_jet>=4)) return false; // nJet >=4 or (metLD > 30GeV, if SFOS, metLD > 45)
...
bool ttHVars::Is4lctrlSR(EventContainer* EvtObj){
    if(nLep_Cat !=4 || nLepFO <4) return false;
    if(!(fakeLeptons.at(0).isMVASel() ==1 && fakeLeptons.at(1).isMVASel() ==1 && fakeLeptons.at(2).isMVASel() ==1 && fakeLeptons.at(3).isMVASel() ==1 ) )return false; // selected leptons are tights
    if(EvtObj->massL_SFOS > 101.2 || EvtObj->massL_SFOS < 81.2) return false; // inversed cut Z veto
    //if(!(EvtObj->metLD > (isSFOS_metLD ==1 ? 45 : 30) || n_presel_jet>=4)) return false; // nJet >=4 or (metLD > 30GeV, if SFOS, metLD > 45)
...
bool ttHVars::Is4lctrlFake(EventContainer* EvtObj){
    if(nLep_Cat !=4 || nLepFO <4) return false;
    if(fakeLeptons.at(0).isMVASel() ==1 && fakeLeptons.at(1).isMVASel() ==1 && fakeLeptons.at(2).isMVASel() ==1 && fakeLeptons.at(3).isMVASel() ==1 )return false; // selected leptons are not all tights
    if(EvtObj->massL_SFOS > 101.2 || EvtObj->massL_SFOS < 81.2) return false; // inversed cut Z veto
    //if(!(EvtObj->metLD > (isSFOS_metLD ==1 ? 45 : 30) || n_presel_jet>=4)) return false; // nJet >=4 or (metLD > 30GeV, if SFOS, metLD > 45)
